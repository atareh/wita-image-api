...
export default async function handler(req, res) {
  ...
  <svg width="1080" height="1350" xmlns="http://www.w3.org/2000/svg">
    <style>
      .bg          { fill: #fefae0; }
      .headline    { fill: #001f2b; font-size: 60px; font-weight: bold;   font-family: 'DejaVu Sans', sans-serif; }
      .subtext     { fill: #333;   font-size: 32px;                      font-family: 'DejaVu Sans', sans-serif; }
      .verdict-bar { fill: #db0001; }
      .verdict     { fill: #fff;   font-size: 48px; font-weight: bold;   font-family: 'DejaVu Sans', sans-serif; }
      .footer      { fill: #444;   font-size: 28px;                      font-family: 'DejaVu Sans', sans-serif; }
    </style>
